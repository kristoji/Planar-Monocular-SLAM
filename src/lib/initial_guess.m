function [XL_guess, guessed] = initial_guess(observations, XR_guess, use_multi_view_triangulation, use_only_this_landmark)
    ...
    if ~use_multi_view_triangulation,
        points_to_plot = [];
        choosen_land = use_only_this_landmark; % to test only on one landmark
